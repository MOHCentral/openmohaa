...
if(BUILD_GAME_LIBRARIES)
    ...
    target_compile_definitions( ${GAME_MODULE_BINARY_MISSIONPACK} PRIVATE QAGAME MISSIONPACK ${GAME_DEFINITIONS})
    target_include_directories( ${GAME_MODULE_BINARY_MISSIONPACK} PRIVATE ${YAML_CPP_INCLUDE_DIRS} ${GAME_INCLUDE_DIRS})
    target_link_libraries(      ${GAME_MODULE_BINARY_MISSIONPACK} PRIVATE ${YAML_CPP_LIBRARIES})
    target_link_libraries(      ${GAME_MODULE_BINARY_MISSIONPACK} PRIVATE ${GAME_LIBRARIES})
