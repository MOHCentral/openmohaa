...
if(BUILD_GAME_LIBRARIES)
    ...
    target_include_directories( ${GAME_MODULE_BINARY_BASEGAME} PRIVATE ${YAML_CPP_INCLUDE_DIRS} ${GAME_INCLUDE_DIRS})
    ...
    target_link_libraries(      ${GAME_MODULE_BINARY_BASEGAME} PRIVATE ${GAME_LIBRARIES})
