...
UILayout::UILayout(const char *filename)
{
    BogusFunction();
    m_script   = NULL;
    m_filename = filename;
...
void UILayout::BogusFunction(void) {}

void UILayout::CreateWidgetContainer(Event *ev)
{
    str   name;
    str   direction;
    float w, h;
...
void UILayout::ProcessCommands(bool bFullLoad)
{
    const char *token;
    Event      *ev;
    UIWidget   *widget;
